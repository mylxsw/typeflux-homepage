...
const translations = {
  ...
  'zh-CN': {
    ...
    hero: {
      title1: '你说内容。',
      title2: '我来打字。',
      subtitle: '按下 Fn 键自然说话，Typeflux 会将精准极速的语音转文本直接送到任何应用中。最棒的是？它免费、开源，并且支持本地模型。',
      downloadBtn: '免费下载',
      sourceBtn: '查看源码',
    },
    features: {
  ...
  'zh-TW': {
    ...
    hero: {
      title1: '你說內容。',
      title2: '我來打字。',
      subtitle: '按下 Fn 鍵自然說話，Typeflux 會將精準極速的語音轉文字直接送到任何應用中。最棒的是？它免費、開源，並且支援本地模型。',
      downloadBtn: '免費下載',
      sourceBtn: '查看原始碼',
    },
    features: {
  ...
  ja: {
    ...
    hero: {
      title1: '話して。',
      title2: '私たちが入力します。',
      subtitle: 'Fnキーを押して自然に話してください。Typefluxは正確で超高速な音声入力を直接どのアプリにも届けます。しかも無料、オープンソース、ローカルモデル対応。',
  ...
  ko: {
    ...
    hero: {
      title1: '말하세요.',
      title2: '우리가 타이핑할게요.',
      subtitle: 'Fn 키를 누르고 자연스럽게 말하세요. Typeflux는 정확하고 초고속의 음성 입력을 모든 앱에 직접 전달합니다. 무엇보다도 무료이며, 오픈소스이고, 로컬 모델을 지원합니다.',
      downloadBtn: '무료 다운로드',
      sourceBtn: '소스코드 보기',
    },
    features: {
